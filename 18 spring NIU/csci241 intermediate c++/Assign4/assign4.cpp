...
int  main()
   ...
   cout << v3 * v4 << endl;     //returning a float.  taking in vector3 object as argument
   ...
   double k = 2.345;
   			...
   			//test 4
   cout << v3 << " * " << k << " = " << v3 * k << endl;  //returning a vector3 object but taking in float as argument
   cout << k << " * " << v4 << " = " << k * v4 << endl;  //returning a vecto3obect      taking in vector 3 object as argument
 				//friend
