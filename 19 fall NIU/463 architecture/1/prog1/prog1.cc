...
/*
as we are doing only 2 strings at a time, easy to do it this way loops are doign dandling string nonsense in earlier version FML!
*/
...
/*
takes a line and returns a bool. 
count number of 0's
simple mod 2 bool.  odd or even
*/
bool isEven(string s) {
...
/*
takes in 2 strings
and two ptr to bools if signed or unsigned
return outStr
*/
...
/*
takes 1 char at a time 
adds it including the carry in ptr
return int  of 1 if 0+1 or 0 if 1+1 or 1 if 1+1+1. 

changes the value in original carry in benifit of using ptr
*/
int fullAdder(char c1, char c2, int *carryIn) {
...
/*
takes a line and returns a string object. 
...
takes a line and returns a bool. 
count number of 0's
return true if 0 found return false else.  its for z flag
*/
bool isZeros(string v1) {
  for (int i = (int)v1.length()-1; i>=0;i--) {
    if (v1[i] == '1') {
